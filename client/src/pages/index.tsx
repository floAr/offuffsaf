          ...
          <VStack maxW={350} spacing={4}>
            ...
            {!profile ? (<>
              ...
              {activeStep == 1 && (<VStack spacing={3}>
                <Box><Link color='teal.500' href="https://zupass.org/#/add-subscription?url=https%3A%2F%2Fzupass-feed.vercel.app%2Fapi%2Ffeeds" onClick={() => { setSubscribed(true) }} isExternal>Subscribe</Link> to the  &apos;ETHBerlin-Zumeet&apos; feed.</Box>
